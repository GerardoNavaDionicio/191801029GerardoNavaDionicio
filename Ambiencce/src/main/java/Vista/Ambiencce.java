 ...
 * @author GenadyThink
 */
public class Ambiencce extends javax.swing.JFrame {

    /**
     * Creates new form Ambiencce
     */
    public Ambiencce() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        voltajeText = new javax.swing.JTextField();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(Marca)
                    .addComponent(marcaText, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(51, 51, 51)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(tipo)
                    .addComponent(tipoText, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(28, 28, 28)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(voltaje)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(voltajeText, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(65, 65, 65)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(voltajeText, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(insertar))
    ...
    private void insertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertarActionPerformed
        ...
        String voltaje = voltajeText.getText();
        Iluminacion iluminacion = new Iluminacion(marca, tipo, NORMAL);
        try {
            DaoIluminacion.insertar(iluminacion);
        } catch (SQLException ex) {
            Logger.getLogger(Ambiencce.class.getName()).log(Level.SEVERE, null, ex);
        }
        finally {
            marcaText.setText("");
            tipoText.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Ambiencce.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField voltajeText;
